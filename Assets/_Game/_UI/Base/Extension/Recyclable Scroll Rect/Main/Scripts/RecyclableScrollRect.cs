...
namespace PolyAndCode.UI
{
    ...
    {
        public event Action<Vector2> _OnValueChange;
        public event Action _OnAnchorChange;
        [HideInInspector]
        ...
        public int MinPoolSize => _recyclingSystem.MinPoolSize;
        ...
        public List<ICell> CachedCells => _recyclingSystem.CachedCells;
        ...
        private void Initialize()
        {
            ...
            _recyclingSystem._OnAnchorChange -= OnAnchorChange;
        ...
        public void OnValueChangedListener(Vector2 normalizedPos)
        {
            ...
            _prevAnchoredPos = content.anchoredPosition;
            _OnValueChange?.Invoke(normalizedPos);
        }

        protected void OnAnchorChange()
        {
            _OnAnchorChange?.Invoke();
        }
