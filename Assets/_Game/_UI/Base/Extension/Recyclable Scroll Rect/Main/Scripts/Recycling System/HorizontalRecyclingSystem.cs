...
namespace PolyAndCode.UI
{
    ...
    public class HorizontalRecyclingSystem : RecyclingSystem
    {
        ...
        public override List<ICell> CachedCells => _cachedCells;
        #region INIT
        ...
        public override IEnumerator InitCoroutine(Action onInitialized)
        {
            ...
            {
                contentXSize += horizontalLayout.padding.left + horizontalLayout.padding.right;
            }
        ...
        private Vector2 RecycleLeftToRight()
        {
            ...
            while (_cellPool[leftMostCellIndex].MaxX() < _recyclableViewBounds.min.x && currentItemCount < DataSource.GetItemCount())
            {
                ...
                else
                {
                    ...
                    _cellPool[leftMostCellIndex].SetAsLastSibling();
                    AnchorChange();
                }
        ...
        private Vector2 RecycleRightToleft()
        {
            ...
            while (_cellPool[rightMostCellIndex].MinX() > _recyclableViewBounds.max.x && currentItemCount > _cellPool.Count)
            {
                ...
                else
                {
                    ...
                    _cellPool[rightMostCellIndex].SetAsFirstSibling();
                    n++;
                    AnchorChange();
                }
        ...
        {
            for (int i = leftMostCellIndex; i < leftMostCellIndex + MinPoolSize; i++)
            {
                DataSource.SetCell(_cachedCells[i - leftMostCellIndex], _cachedCells[i - leftMostCellIndex].CellIndex);
            }
        }
        #endregion
